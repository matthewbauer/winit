...
use smithay_client_toolkit::{
    ...
    reexports::{
        ...
        protocols::unstable::relative_pointer::v1::client::{
            ...
            zwp_relative_pointer_v1::Event, zwp_relative_pointer_v1::ZwpRelativePointerV1,
        },
    },
};
...
pub fn implement_pointer(
    ...
    pointer.quick_assign(move |pointer, evt, _| {
...
pub fn implement_relative_pointer(
    sink: EventsSink,
    pointer: &WlPointer,
    manager: &Attached<ZwpRelativePointerManagerV1>,
) -> ZwpRelativePointerV1 {
    let rel_pointer = manager.get_relative_pointer(pointer);
    rel_pointer.quick_assign(move |_, evt, _| match evt {
